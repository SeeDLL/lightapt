window.YL = {
  info: {
    softwareName: 'LightAPT Desktop',
    version: window.LightAPTVersion,
    iconBtnStart: 'window',
    modified_author: 'Max Qian',
    officialWebsite: 'https://lightapt.cn',
    copyrightDetail: '基于Yuri的开源天文桌面软件',
    otherStatements: '',
  },
  data: {},
  lang: function (key) {
  ...
  _baseData: function () {
    return {
      ...
      configs: {
        ...
        sound: true,//开启声音
        wallpaper: '/static/textures/background.png',
  ...
  loadRes: function () {
    ...
    //jq
    YL.util.loadScript('/static/js/jquery/jquery.min.js', function () {
      onLoading = 'jquery.min.js';
      counterLoad++;

      //contextMenu
      YL.util.loadScript('/static/js/desktop/contextMenu.min.js' + versionTail, function () {
        onLoading = 'contextMenu.min.js';
        counterLoad++;
      });
      YL.util.loadStyle('/static/css/desktop/contextMenu.min.css' + versionTail, function () {
        onLoading = 'contextMenu.min.css';
        counterLoad++;
      });
      YL.util.loadScript('/static/js/jquery/jquery.nicescroll.min.js', function () {
        onLoading = 'jquery.nicescroll.min.js';
        counterLoad++;
      });
      YL.util.loadScript('/static/js/desktop/layer.min.js', function () {
        onLoading = 'layer.min.js';
        counterLoad++;
      });
    });
    YL.util.loadStyle('/static/css/desktop/main.css' + versionTail, function () {
      onLoading = 'main.css';
      counterLoad++;
    });
    YL.util.loadStyle('/static/css/desktop/yl-layer-skin.css' + versionTail, function () {
      onLoading = 'yl-layer-skin.css';
      counterLoad++;
    });
    YL.util.loadStyle('/static/css/desktop/layer.min.css' + versionTail, function () {
      onLoading = 'layer.min.css';
      counterLoad++;
    });
    YL.util.loadStyle('/static/css/desktop/tiles.css' + versionTail, function () {
      onLoading = 'tiles.css';
      counterLoad++;
    });
    YL.util.loadStyle('/static/css/plugins/animate.min.css' + versionTail, function () {
      onLoading = 'animate.min.css';
      counterLoad++;
    });
    YL.util.loadScript('/static/js/desktop/Yuri2.js' + versionTail, function () {
      onLoading = 'Yuri2.js';
      counterLoad++;
    });
    YL.util.loadStyle('/static/css/fontawesome/fontawesome.min.css', function () {
      onLoading = 'fontawesome.min.css';
      counterLoad++;
    });

    counterLoad++;

    YL.util.loadPrefetch('/static/font/desktop/element-icons.woff?t=1510834658947', function () {
      onLoading = 'element-icons.woff';
      counterLoad++;
    });
    YL.util.loadPrefetch('/static/css/desktop/element-ui.min.css', function () {
      onLoading = 'element-ui.min.css';
      counterLoad++;
    });
    YL.util.loadPrefetch('/static/js/desktop/element-ui.min.js', function () {
      onLoading = 'element-ui.min.js';
      counterLoad++;
    });
    YL.util.loadScript('/static/js/plugins/vue.min.js', function () {
      onLoading = 'vue.min.js';
      counterLoad++;

      YL.util.loadScript('/static/js/desktop/vue-grid-layout.umd.min.js', function () {
        onLoading = 'vue-grid-layout.min.js';
        counterLoad++;
      });
      YL.util.loadScript('/static/js/desktop/yl-vue-component-icon.js' + versionTail, function () {
        onLoading = 'yl-vue-component-icon.js';
        counterLoad++;
      });
      YL.util.loadScript('/static/js/desktop/yl-vue-components.js' + versionTail, function () {
        onLoading = 'yl-vue-components.js';
        counterLoad++;
      });

    });
    YL.util.loadScript('/static/js/desktop/yl-render.js' + versionTail, function () {
      onLoading = 'yl-render.js';
      counterLoad++;
    });
    YL.util.loadScript('/static/js/desktop/yl-io.js' + versionTail, function () {
      onLoading = 'yl-io.js';
      counterLoad++;
    });
    YL.util.loadScript('/static/js/desktop/calendar/calendar.js' + versionTail, function () {
      onLoading = 'calendar.script';
      counterLoad++;
    });
    YL.util.loadStyle('/static/css/desktop/calendar/calendar.css' + versionTail, function () {
...
YL.util.onloadSafe(function () {
  YL.util.loadScript('/static/js/desktop/configs.js', function () {
    ...
    YL.util.loadContentFromUrl('/static/json/langs/' + YL.static.lang + '.json', 'GET', function (err, text) {
      if (!err) {
